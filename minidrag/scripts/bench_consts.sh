...
# GLOBAL_DATA_ARGS=""
GLOBAL_DATA_ARGS="--max-concurrency 1 --request-sampling-method zipf --request-zipf-param 1.01 --sample-documents 10 --document-sampling-method zipf --document-zipf-param 1.01"
